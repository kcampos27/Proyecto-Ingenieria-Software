...
public class StrategyUltra implements StrategySoltarBomba{
    public void soltarBomba(BomberMan pBomber) {
        if (pBomber.tipo.equals("blanco")){
            if (pBomber.bombasActivas < 1 &&
                ...
                Gestor.getInstance().getTablero().aniadirContent(pBomber.x, pBomber.y, new BombaUltra(pBomber.x, pBomber.y));
